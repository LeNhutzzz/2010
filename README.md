...
<body>
    ...
    <!-- Nhạc nền  -->
    <audio id="player" src="./assets/Phép Màu (Đàn Cá Gỗ OST) - Mounter x MAYDAYs, Minh Tốc  Official MV - Mounter.mp3"></audio> <!-- Sửa bài hát ở đây -->

    <script>
        //Sửa ảnh và lời nhắn ở đây
        const messages = [
            {
                img: "./assets/Anh-meme-meo-1.jpg", //Thay ảnh
            ...
            {
                img: "./assets/895c4074f4663dd4fb8d63c652242255.jpg",
            ...
            {
                img:"./assets/anh-meme-meo-cute-de-thuong.jpg",
            ...
            {
                img: "./assets/cho-husky-gio-tay-10-diem-meme.jpg",
